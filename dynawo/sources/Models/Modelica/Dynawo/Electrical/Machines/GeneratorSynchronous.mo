...
model GeneratorSynchronous "Synchronous machine"
  ...
  */
  ...
  public
    ...
    Types.ActivePowerPu PGenPuPNom(start = PGen0Pu*SystemBase.SnRef/PNom) "Active power generated by the synchronous machine in p.u (base PNom)";
