...
build_dynawo_core() {
  ...
  cmake --build $DYNAWO_BUILD_DIR -j $DYNAWO_NB_PROCESSORS_USED --config $DYNAWO_BUILD_TYPE && cmake --build $DYNAWO_BUILD_DIR --target install --config $DYNAWO_BUILD_TYPE
  RETURN_CODE=$?
  return ${RETURN_CODE}
}
...
build_dynawo_models_cpp() {
  ...
  cmake --build $DYNAWO_BUILD_DIR -j $DYNAWO_NB_PROCESSORS_USED --target models-cpp --config $DYNAWO_BUILD_TYPE || error_exit "Error during build models-cpp."
}
...
build_dynawo_models() {
  ...
  cmake --build $DYNAWO_BUILD_DIR -j $DYNAWO_NB_PROCESSORS_USED --target models --config $DYNAWO_BUILD_TYPE || error_exit "Error during build models."
}
...
build_dynawo_solvers() {
  ...
  cmake --build $DYNAWO_BUILD_DIR -j $DYNAWO_NB_PROCESSORS_USED --target solvers --config $DYNAWO_BUILD_TYPE || error_exit "Error during build solvers."
}
...
build_doxygen_doc() {
  ...
  cmake --build $DYNAWO_BUILD_DIR --target doc -j $DYNAWO_NB_PROCESSORS_USED
  RETURN_CODE=$?
  return ${RETURN_CODE}
}
